package com.feng.dataStructure.ch12_tree.t1_binarytree;
...
*
* 二叉树分为 满二叉树 和 完全二叉树
* 满二叉树：该二叉树的所有叶子节点都在最后一层，并且结点总数= 2^n -1 , n 为层数
* 完全二叉树： 该二叉树的所有叶子节点都在最后一层或者倒数第二层，而且最后一层的叶子节点在左边连续，倒数第二层的叶子节点在右边连续
*
* 二叉树的 遍历
* 1、前序遍历
* 2、中序遍历
