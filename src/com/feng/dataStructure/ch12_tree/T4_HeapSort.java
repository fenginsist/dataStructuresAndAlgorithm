package com.feng.dataStructure.ch12_tree;
...
//        int[] array = {4, 6, 8, 5, 9};
        ...
        System.out.println(Arrays.toString(array)); // [-999, -1, 4, 5, 6, 8, 9, 56, 89, 90]
        System.out.println();
...
//        System.out.println("第 2 次："+Arrays.toString(array));  // [9, 6, 8, 5, 4]
        ...
        /*
         * 对上面的 两步规律 进行整合，完成我们最终代码， 使用for 循环，使用 array.length / 2 - 1 找到第一个非叶子结点。
...
//        System.out.println("排序后："+Arrays.toString(array));  // [9, 6, 8, 5, 4]
     ...
     *
     * @param array 待调整的数组
     * @param i 表示 非叶子节点 的在数组中的索引，就是当前结点, 第一个值 为 从左到右，从下到上，第一个非叶子结点：length/2-1
    ...
    public static void adjustHeap(int[] array, int i, int length) {
        ...
        /*
         * 开始调整
         * 1、k = i * 2 + 1: k 是以 i 为当前结点 非叶子结点的 左子结点，
         * 2、k + 1：则为右子结点
         * */
